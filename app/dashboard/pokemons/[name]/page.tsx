import { Pokemon, SinglePokemon } from "@/app/lib/pokemons";
...
export async function generateStaticParams() {
    const data: Pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/?limit=151`)
        .then(data => data.json())
...
async function getPokemonByName(name: string): Promise<SinglePokemon> {
    try {
...
export default async function PokemonNamePage({ params: { name } }: Props) {
